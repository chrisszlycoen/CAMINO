...
export default function RoutesPage() {
  ...
  useEffect(() => { DataService.getRoutes().then(setRoutes); }, []);
    ...
    <DashboardLayout>
      <div className="p-6 lg:p-8 animate-in">
        <div className="flex items-start justify-between mb-6">
          ...
          <button onClick={openAdd} className="btn-primary">➕ Add Route</button>
        </div>
            ...
            <div key={r.id} className="data-card p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#0A3D2F]/10 flex items-center justify-center text-[#0A3D2F]">🗺️</div>
                  <div>
