          ...
          children: [
            ...
            CaminoCard(
              ...
              child: ListTile(
                ...
                onTap: () => context.push('/parent/linked-children'),
              ),
            ),
            ...
            CaminoCard(
              ...
              child: Column(
                children: [
                  ...
                  _SettingsListItem(icon: Icons.language, title: 'Language', value: 'English', onTap: () => context.push('/settings')),
                  Divider(height: 1, color: dividerColor, thickness: 0.5),
                  _SettingsListItem(icon: Icons.notifications_active, title: 'Notification Preferences', onTap: () => context.push('/settings')),
                  Divider(height: 1, color: dividerColor, thickness: 0.5),
                  _SettingsListItem(icon: Icons.contact_support, title: 'Contact Support', onTap: () => context.push('/help')),
                  Divider(height: 1, color: dividerColor, thickness: 0.5),
                  _SettingsListItem(icon: Icons.info_outline, title: 'About CAMINO', onTap: () => context.push('/about')),
                ],
              ),
            ),
